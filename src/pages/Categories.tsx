...
export default function Categories() {
  const { data, addCategory, updateCategory, deleteCategory } = useStoreContext();
        ...
        <div className="space-y-4">
          ...
          <FormField label="顏色">
            ...
            <Input
              ...
              className="mt-2 h-9 p-1 cursor-pointer"
            />
          </FormField>
